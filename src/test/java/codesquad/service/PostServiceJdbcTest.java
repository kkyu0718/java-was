...
class PostServiceJdbcTest {
    ...
    void 주어진_유저가_존재할_때_게시글을_작성하면_성공한다() {
        // given
        PostCreateDao dao = new PostCreateDao(existUserId1, "content1");
    ...
    void 여러_게시글이_존재할_때_모든_게시글을_가져올_수_있다() {
        // given
        PostCreateDao dao1 = new PostCreateDao(existUserId1, "First post");
        PostCreateDao dao2 = new PostCreateDao(existUserId2, "Second post");
    ...
    void 주어진_유저가_존재하지_않을_때_게시글을_작성하면_실패한다() {
        // given
        PostCreateDao dao = new PostCreateDao("not-existing-user", "content1");
